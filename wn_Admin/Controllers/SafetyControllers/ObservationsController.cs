...
namespace wn_Admin.Controllers.SafetyControllers
{
    public class ObservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ObservationID,ObservationName")] Observation observation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ObservationID,ObservationName")] Observation observation)
        {
            if (ModelState.IsValid)
            {
