...
namespace wn_Admin.Controllers.CompanyControllers
{
    ...
    public class AccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccountTypeID,AccountName")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccountTypeID,AccountName")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
