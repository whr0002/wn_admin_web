...
namespace wn_Admin.Controllers.CControllers
{
    public class PayPeriodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PayPeriodID,StartDate")] PayPeriod payPeriod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PayPeriodID,StartDate")] PayPeriod payPeriod)
        {
            if (ModelState.IsValid)
            {
